    ...
    return (
        <div>
            <div style={{ backgroundColor: '#fff', marginBottom: '30px', marginTop: '30px', height: '100px', textAlign: 'left', paddingRight: '10px', paddingLeft: '10px', alignSelf: 'center', paddingTop: '0.5px' }}>
                <p style={{ fontWeight: '100', fontSize: '23px', color: "#676A6C" }}>User Record</p>
                <p style={{ marginTop: '-20px', fontSize: '15px', color: "#676A6C" }}>Dashboard</p>
            </div>
            <div style={{ backgroundColor: '#fff', marginBottom: '30px', marginTop: '30px', height: '100px', textAlign: 'left', paddingRight: '10px', paddingLeft: '10px', alignSelf: 'center', paddingTop: '0.5px' }}>
                <p style={{ fontWeight: '100', fontSize: '15px', color: "#676A6C" }}>Select User</p>
            </div>
            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#fff' }}>
                <div id='chartdiv' style={{ width: '47%', height: '500px' }} />
                <div id='chartdivv' style={{ width: '47%', height: '500px' }} />
            </div>
            <div style={{padding:'5px 0px 0px 0px',backgroundColor:'#fff',textAlign:'left',padding:'10px'}}>
                {renderTable()}
            </div>
